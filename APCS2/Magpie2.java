...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "jahnke") >= 0
                || findKeyword(statement, "Jahnke") >= 0)
        {
     ...
     * @param statement the user statement, assumed to contain "I" followed by "yo"
     * @return the transformed statement
     */
...
I want some chicken
Would you really be happy if you had some chicken?
I like you
Why do you like me?
You and I should go camping
You don't say.
me and you - one the road
Interesting, tell me more.
no
Why so negative?
Bye
